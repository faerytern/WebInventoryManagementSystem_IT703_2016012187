...
namespace WebInventoryManagementSystem_IT703_2016012187.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(WebInventoryManagementSystem_IT703_2016012187Context context)
        {
            _context = context;
        }
        ...
        {
            var webInventoryManagementSystem_IT703_2016012187Context = _context.Product.Include(p => p.Brand).Include(p => p.Category);
        ...
        public async Task<IActionResult> Create([Bind("ProductId,SKU,Name,BrandId,CategoryId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,SKU,Name,BrandId,CategoryId")] Product product)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebInventoryManagementSystem_IT703_2016012187Context.Product'  is null.");
            }
            var product = await _context.Product.FindAsync(id);
            if (product != null)
            {

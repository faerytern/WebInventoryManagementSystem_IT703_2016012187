...
namespace WebInventoryManagementSystem_IT703_2016012187.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public SuppliersController(WebInventoryManagementSystem_IT703_2016012187Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebInventoryManagementSystem_IT703_2016012187Context.Supplier'  is null.");
            }
            var supplier = await _context.Supplier.FindAsync(id);
            if (supplier != null)
            {

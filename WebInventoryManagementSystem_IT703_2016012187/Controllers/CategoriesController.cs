...
namespace WebInventoryManagementSystem_IT703_2016012187.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(WebInventoryManagementSystem_IT703_2016012187Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebInventoryManagementSystem_IT703_2016012187Context.Category'  is null.");
            }
            var category = await _context.Category.FindAsync(id);
            if (category != null)
            {
